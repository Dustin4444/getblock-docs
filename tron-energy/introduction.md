---
description: >-
  Learn about GetBlock Tron Energy, how to rent Tron energy and bandwidth
  through API or Dashboard UI
---
...
2. [Tron Fee Model](tron-fee-model.md)
3. [Pricing](api-reference/)
