...
description: >-
  ...
  Complete guide to using the eth_getTransactionByBlockHashAndIndex JSON-RPC
  method in GetBlock.io Web3 documentation.
---

# eth\_getTransactionByBlockHashAndIndex - Robinhood

Returns a transaction by block hash and its index within the block.
...
| index     | QUANTITY        | Yes      | Transaction index in the block (hex) |
...
* Sequential transaction processing within a block
* Indexers walking transactions by position
...
const result = await provider.send('eth_getTransactionByBlockHashAndIndex', ["0x8b5c6f1a9e8d7c6b5a4f3e2d1c0b9a8e7f6d5c4b3a2b1f9e8d7c6b5a4f3e2d1c", "0x0"]);
console.log(result);
...
const result = await client.request({
    method: 'eth_getTransactionByBlockHashAndIndex',
    params: ["0x8b5c6f1a9e8d7c6b5a4f3e2d1c0b9a8e7f6d5c4b3a2b1f9e8d7c6b5a4f3e2d1c", "0x0"]
});
console.log(result);
