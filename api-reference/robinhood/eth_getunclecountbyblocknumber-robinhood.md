---
description: >-
  Example code for the eth_getUncleCountByBlockNumber JSON-RPC method. Complete
  guide to using the eth_getUncleCountByBlockNumber JSON-RPC method in
  GetBlock.io Web3 documentation.
---

# eth\_getUncleCountByBlockNumber - Robinhood

Returns the number of uncle blocks for a given block number. **Always `0x0` on Robinhood Chain**. Included for compatibility.
