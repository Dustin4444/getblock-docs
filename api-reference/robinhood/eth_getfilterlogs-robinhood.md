---
description: >-
  Example code for the eth_getFilterLogs JSON-RPC method. Complete guide to
  using the eth_getFilterLogs JSON-RPC method in GetBlock.io Web3 documentation.
---

# eth\_getFilterLogs - Robinhood

Returns all logs matching a filter — not just changes since the last call. Only works with log filters created by `eth_newFilter` (not block or pending-tx filters).
...
| ------ | ------------ | ----------------- |
| result | array of Log | All matching logs |

## Use Cases

* Backfilling logs after creating a filter
* Initial historical scan before switching to incremental polling
