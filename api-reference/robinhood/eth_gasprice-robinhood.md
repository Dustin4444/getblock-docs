---
description: >-
  Example code for the eth_gasPrice JSON-RPC method. Complete guide to using the
  eth_gasPrice JSON-RPC method in GetBlock.io Web3 documentation.
---

# eth\_gasPrice - Robinhood

Returns the current gas price suggested by the node, in wei. Robinhood Chain uses ETH as gas token (identical to Ethereum mainnet); gas prices are typically much lower than L1 due to the L2 rollup architecture.
...
| ------ | -------- | ---------------------------------------------------------------------------- |
| result | QUANTITY | Current gas price in wei (hex). Denominated in ETH — divide by 10^9 for gwei |

## Use Cases

* Pre-EIP-1559 gas price estimation
* Legacy transaction fee calculations
