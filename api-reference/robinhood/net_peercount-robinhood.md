---
description: >-
  Example code for the net_peerCount JSON-RPC method. Complete guide to using
  the net_peerCount JSON-RPC method in GetBlock.io Web3 documentation.
---

# net\_peerCount - Robinhood

Returns the number of peers currently connected to the client. Hex-encoded.
...
| ------ | -------- | ------------------------------- |
| result | QUANTITY | Number of connected peers (hex) |

## Use Cases

* Monitoring P2P network health
* Detecting node isolation or peer-discovery problems
