...
description: >-
  ...
  guide to using the eth_newPendingTransactionFilter JSON-RPC method in
  GetBlock.io Web3 documentation.
---

# eth\_newPendingTransactionFilter -Robinhood

Creates a filter for pending transactions entering the mempool. `eth_getFilterChanges` returns the hashes of new pending transactions.
...
* Front-running detection (FCFS ordering makes classical mempool front-running less common but still possible)
